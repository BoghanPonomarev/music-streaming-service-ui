...
export default {
    ...
    //Page singin
    'app.page.auth.welcome':'Welcome to uPlan',
    'app.page.singin.newtous':'New to uPlan?',
    'app.page.singin.joinus':'Join us',
    'app.page.singin.singin':'Sing in',
    'app.page.singup.join':'Join',
    'app.page.singup.alreadywu':'Already with us?',
    'app.page.singup.singin':'Sing in',
    'app.page.auth.repeatpassword':'repeat password',
